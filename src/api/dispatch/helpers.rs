...
pub(crate) fn template_id_for_tag(tag: TechniqueTag) -> &'static str {
    match tag {
        ...
        TechniqueTag::BareissElimination => "step.bareiss_elimination",
        TechniqueTag::GaussJordanElimination => "step.gauss_jordan_elimination",
        TechniqueTag::RowReduction => "step.row_reduction",
        TechniqueTag::NullSpaceComputation => "step.null_space_computation",
        TechniqueTag::ColumnSpaceComputation => "step.column_space_computation",
        TechniqueTag::RankComputation => "step.rank_computation",
        TechniqueTag::CholeskyDecomposition => "step.cholesky_decomposition",
        TechniqueTag::SvdDecomposition => "step.svd_decomposition",
        TechniqueTag::GramSchmidt => "step.gram_schmidt",
        TechniqueTag::SymbolicEigenvector => "step.symbolic_eigenvector",
        TechniqueTag::MinimalPolynomial => "step.minimal_polynomial",
        TechniqueTag::QuadraticFormAnalysis => "step.quadratic_form_analysis",
