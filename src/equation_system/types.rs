//! Type definitions for the equation system module.
//!
//! Contains all struct/enum definitions used across the equation system,
//! including error types, equation classification, system context,
//! dependency graph, solution types, and resolution path tracking.
